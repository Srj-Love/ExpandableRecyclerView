package com.example.suraj.expandablerecyclerview.HeroAdapter;
...
import com.example.suraj.expandablerecyclerview.Hero;
import com.example.suraj.expandablerecyclerview.R;
...
public class HeroAdapter extends RecyclerView.Adapter<HeroAdapter.HeroViewHolder> {
    ...
    // create a ViewHolder class ,where all the view will be initialise
    ...
    public void onBindViewHolder(final HeroViewHolder holder,  int position) {
        Hero hero = heroList.get(holder.getAdapterPosition());
